...
$admin = new admin();
$products = $admin->getProductsForApproval();
        ...
        <div class="page-content--bgf7">
            ...
            <section class="p-t-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="title-5 m-b-35">Approvals</h3>
                                    ...
                                    <tbody>
                                        <?php foreach ($products as $product) : ?>
                                            <tr class="tr-shadow">
                                                ...
                                                <td><?php echo $product["endtime"] ?></td>
                                                <td><?php echo $product["price"] ?></td>

                                                <td>
                                                    <div class="table-data-feature">
                                                        <button  onclick="location.href = '../controller.php?page=approve_product&id=<?php echo $product['auction_id']; ?>';" type="button" class="btn btn-success">
                                            <i class="fa fa-magic"></i>&nbsp; Approve Product</button>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr class="spacer"></tr>
