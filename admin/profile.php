                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <button class="item" onclick="location.href = 'update_category.php?id=<?php echo  $category['categories_id']; ?>';" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </button>
                                                        <button class="item" onclick="location.href = '../controller.php?page=delete_category&id=<?php echo $category['categories_id']; ?>';" data-toggle="tooltip" data-placement="top" title="Delete">
