...
$admins = $super_admin->getAdmins();
$categories = $super_admin->getCategories();
        ...
        <div class="page-content--bgf7">
            ...
            <section class="p-t-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="title-5 m-b-35">Current Admins</h3>
                            <div class="table-data__tool">
                                <div class="table-data__tool-left">
                                </div>
                                <div class="table-data__tool-right">
                                    <button class="au-btn au-btn-icon au-btn--green au-btn--small" onclick="location.href = 'add_admin.php';">
                                ...
                                <table class="table table-data2">
                                    ...
                                    <?php foreach ($admins as $admin): ?>
                                        <tr class="tr-shadow">
                                            ...
                                            <td>
                                                <span class="block-email"><?php echo $admin["email"]?></span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="table-data-feature">
                                                    <button class="item" onclick="location.href = 'update_admin.php?id=<?php echo $admin['user_id'];?>';" data-toggle="tooltip" data-placement="top" title="Edit">
                                                        <i class="zmdi zmdi-edit"></i>
                                                    </button>
                                                    <button class="item" onclick="location.href = '../controller.php?page=delete_admin&id=<?php echo $admin['user_id'];?>';" data-toggle="tooltip" data-placement="top" title="Delete">
